var demo = {
	...
	init: function(htmlElementId) {
		...
		div.innerHTML = "<div class='name' style='float:left'>机房名称：</div><div class='namecon'>政务云机房</div>"+
...
/*demo.registerFilter('floor_box1', function(box, json){
	var rotate=json.rotate || [0,0,0];
	return {
		type: 'cube',
		width: 144,
		...
		style:{
			...
			'right.m.lightmap.image': demo.getRes('kongtiao1.png'),
			'front.m.lightmap.image': demo.getRes('kongtiao1.png'),
			'back.m.lightmap.image': demo.getRes('kongt1.jpg'),
			'top.m.normalmap.image': demo.getRes('kongtiao1.png'),
		},
		client: {
			type: 'floor_box'
...
/*
		...
		height: 2,//高
		depth: 1200,//长
		translate: [-1220,100,-10],
	},{
		type: 'floorkt',
		width: 60,//宽
		height: 2,//高
		depth: 1200,//长
		translate: [-1160,100,-10],
	},{
		type: 'floorkt',
		width: 60,//宽
		height: 2,//高
		depth: 1200,//长
		translate: [-780,100,-10],
	},{
		type: 'floorkt',
		width: 60,//宽
		height: 2,//高
		depth: 1200,//长
		translate: [-720,100,-10],
	},{
		type: 'floorkt',
		width: 60,//宽
		height: 2,//高
		depth: 1200,//长
		translate: [-340,100,-10],
	},{
		type: 'floorkt',
		width: 60,//宽
		height: 2,//高
		depth: 1200,//长
		translate: [-280,100,-10],
	},{
		type: 'floorkt',
		width: 60,//宽
		height: 2,//高
		...
		height: 2,//高
		depth: 1200,//长
		translate: [160,100,-10],
	},{
		type: 'floorkt',
		width: 60,//宽
		height: 2,//高
		depth: 1200,//长
		translate: [540,100,-10],
	},{
		type: 'floorkt',
		width: 60,//宽
		height: 2,//高
		depth: 1200,//长
		translate: [600,100,-10],
	},{
		type: 'floorkt',
		width: 60,//宽
		height: 2,//高
		depth: 1200,//长
		translate: [980,100,-10],
	},{
		type: 'floorkt',
		width: 60,//宽
		height: 2,//高
		depth: 1200,//长
		translate: [1040,100,-10],
	},{
		type: 'floorkt',
		width: 60,//宽
		height: 2,//高
		depth: 1200,//长
		translate: [1420,100,-10],
	},*/
	
	{
		type: 'floor_box',
		translate: [-1400, 100, 1000],	
	},
	{
		type: 'floor_box',
		translate: [-900, 100, 1000],	
	},
	{
		type: 'floor_box',
...
//	{
//		type: 'floor_box',
//		translate: [365, 100, 860],	
//	},{
//		type: 'floor_box1',
//		translate: [800, 100, 860],	
//	},{
//		type: 'floor_box',
//		translate: [970, 100, 860],	
//	},{
//		type: 'floor_box',
//		translate: [1165, 100, 860],	
//	},{
//		type: 'floor_box',
//		translate: [1165, 100, -800],
//		rotate: [0, Math.PI/180*180, 0],
//	},{
//		type: 'floor_box',
//		translate: [970, 100, -800],
//		rotate: [0, Math.PI/180*180, 0],
//	},{
//		type: 'floor_box',
//		translate: [775, 100, -800],
//		rotate: [0, Math.PI/180*180, 0],
//	},{
//		type: 'floor_box1',
//		translate: [605, 100, -800],	
//		rotate: [0, Math.PI/180*180, 0],
//	},{
//		type: 'floor_box',
//		translate: [0, 100, -800],
...
//	},{
//		type: 'floor_box',
//		translate: [-195, 100, -800],
//		rotate: [0, Math.PI/180*180, 0],
//	},{
//		type: 'floor_box',
//		translate: [-390, 100, -800],
//		rotate: [0, Math.PI/180*180, 0],
//	},{
//		type: 'floor_box',
//		translate: [-585, 100, -800],
//		rotate: [0, Math.PI/180*180, 0],
//	},{
//		type: 'floor_box1',
//		translate: [-755, 100, -800],
//		rotate: [0, Math.PI/180*180, 0],
//	},
	{
		type: 'wall',//墙
		height: 300,//高 3米
		translate: [0, 0, -1250],//坐标
		//墙的四个点（闭合坐标）
		data: [
			[-2300, 0],
			[2300, 0],
...
//			},
		    {
				...
				height: 180,//高
				depth: 26,//长
				translate: [-2300, 0, -900,],//坐标 2300宽边
				rotate: [0, Math.PI/180*90, 0],
			},	    		    		    		
		],
	},
...
//相对两排机柜之间门
	{
		...
		height: 225,//高
		depth: 2,//长
		translate: [-1078, 100, 632],//坐
	},{
		type: 'rackdoor',//门
		width: 160,//宽
		height: 225,//高
		depth: 2,//长
		translate: [-485, 100, 632],//坐
	},{
		type: 'rackdoor',//门
		width: 160,//宽
		height: 225,//高
		depth: 2,//长
		translate: [100, 100, 632],//坐
	},{
		type: 'rackdoor',//门
		width: 160,//宽
		height: 225,//高
		depth: 2,//长
		translate: [701, 100, 632],//坐
	},{
		type: 'rackdoor',//门
		width: 320,//宽
		height: 225,//高
		depth: 2,//长
		translate: [1374, 100, 632],//坐
	},
	/*{
		type: 'rackdoor',//门
		width: 160,//宽
		height: 225,//高
		depth: 2,//长
		translate: [1685, 100, 632],//坐
	},
	{
		type: 'rackdoor',//门（单排不显示）
		width: 160,//宽
		height: 225,//高
		depth: 2,//长
		translate: [1940, 100, 632],//坐
	},*/
	{
		type: 'rackdoor',//门
		width: 160,//宽
...
//		depth: 2,//长
//		rotate: [0, Math.PI / 180 * 180, 0],
//		translate: [1685, 100, -712],//坐标
//	},
	
	/*{
		type: 'rackdoor1',//门（单排不显示）
		width: 160,//宽
		height: 225,//高
		depth: 2,//长
		rotate: [0, Math.PI / 180 * 180, 0],
		translate: [1940, 100, -590],//坐标
	},*/
	...
	
	{
		...
		[1190,100,-691],
		//J
		/*[680,100,600],[680,100,539],[680,100,478],[680,100,417],[680,100,356],
		[680,100,295],[680,100,234],[680,100,173],[680,100,112],[680,100,51],
		[680,100,-10],[680,100,-71],[680,100,-132],[680,100,-193],[680,100,-254],
		[680,100,-315],[680,100,-376],[680,100,-437],[680,100,-498],[680,100,-559],
		//K
		[900,100,600],
		[900,100,539],
		[900,100,478],
